...
@DATASET_REGISTRY.register('d4rl_trajectory_lightzero')
class D4RLTrajectoryLZDataset(Dataset):
    ...
    def __init__(self, cfg: dict) -> None:
        ...
        rtg_scale = cfg.policy.collect.rtg_scale
        self.context_len = cfg.policy.collect.context_len
        self.env_type = cfg.policy.collect.env_type
