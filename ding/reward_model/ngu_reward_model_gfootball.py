...
with open(os.path.join(os.path.dirname(__file__), '/mnt/lustre/puyuan/DI-engine/dizoo/gfootball/model/q_network/football_q_network_default_config.yaml')) as f:
