...
@POLICY_REGISTRY.register('matd3')
class MATD3Policy(Policy):
    r"""
    Overview:
    ...
    def _forward_learn(self, data: dict) -> Dict[str, Any]:
        ...
        # current q value
        q_value = self._learn_model.forward({'obs': data['obs']}, mode='compute_critic')['q_value']
        q_value_dict = {}
        ...
        with torch.no_grad():
            ...
            # next_actor_data = self._target_model.forward({'obs': next_obs}, mode='compute_actor')
        ...
        if (self._forward_learn_cnt + 1) % self._actor_update_freq == 0:
            ...
            policy_output['logit'][policy_output_next['action_mask'] == 0.0] = -1e8
            prob = F.softmax(policy_output_next['logit'], dim=-1)
    ...
    def default_model(self) -> Tuple[str, List[str]]:
        return 'matd3', ['ding.model.template.matd3']
