...
def train(args):
    main_config.exp_name = 'data_ant/dqn_sbh_ensemble20_k64_upc50_vhd512_noobs_noema_middlenet_beta0.25_vlw0.1' + '_seed' + f'{args.seed}' + '_3M'
...
if __name__ == "__main__":
    ...
    for seed in [0,1,2]:
        ...
        train(args)
        # ant: obs_shape: 111, action_shape: 8
