...
halfcheetah_dqn_default_config = dict(
    exp_name='halfcheetah_dqn_vqvae_seed0',
    env=dict(
...
def train(args):
    ...
    main_config.exp_name = 'data_halfcheetah/dqn_sbh_ensemble20_k128_upc50_obs0_noema_middlenet_beta0.25_vlw0.1' + '_seed' + f'{args.seed}' + '_3M'
