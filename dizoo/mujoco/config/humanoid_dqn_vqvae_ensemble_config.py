...
humanoid_dqn_default_config = dict(
    exp_name='humanoid_dqn_vqvae_seed0',
    env=dict(
        env_id='Humanoid-v3',
...
def train(args):
    main_config.exp_name = 'data_humanoid/dqn_sbh_ensemble20_k128_noobs_soft_upc50_noema_middlenet_beta0.25_vlw0.1' + '_seed' + f'{args.seed}' + '_3M'
