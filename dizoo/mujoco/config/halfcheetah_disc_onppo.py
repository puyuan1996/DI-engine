...
nstep = 3
halfcheetah_onppo_default_config = dict(
...
halfcheetah_onppo_default_config = EasyDict(halfcheetah_onppo_default_config)
main_config = halfcheetah_onppo_default_config

halfcheetah_onppo_create_config = dict(
    env=dict(
        type='mujoco-disc',
...
halfcheetah_onppo_create_config = EasyDict(halfcheetah_onppo_create_config)
create_config = halfcheetah_onppo_create_config


def train(args):
    main_config.exp_name = 'data_halfcheetah/debug_onppo_k729_middlenet' + '_seed' + f'{args.seed}'+'_3M'
