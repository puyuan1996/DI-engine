...
hopper_dqn_default_config = dict(
    ...
    policy=dict(
        ...
        learn=dict(
            ...
            update_per_collect_rl=200,  # for collector n_episode=8
...
def train(args):
    main_config.exp_name = 'data_hopper/dqnvqvae_noema_middlenet_k64_vqvae-lt0_tuf1000' + '_seed' + f'{args.seed}'+'_3M'
