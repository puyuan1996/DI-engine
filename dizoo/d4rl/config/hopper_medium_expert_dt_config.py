...
hopper_dt_config = dict(
    ...
    policy=dict(
        ...
        log_dir = '/mnt/nfs/puyuan/DI-engine/dizoo/d4rl/config',
        model=dict(
            state_dim=11,
            act_dim=3,
            n_blocks=3,
        ...
        learn=dict(
            ...
            dataset_path='/mnt/nfs/share/d4rl/hopper_medium_expert-v2.hdf5',
            # dataset_path='/mnt/nfs/share/d4rl/hopper-medium-expert-v2.pkl',
