...
def train(args):
    ...
    for iter in [-1, 10000, 20000, 40000, 90000, 190000]:
        ...
        if iter == -1:
            visualize_path = f'/Users/puyuan/code/DI-engine/data_lunarlander_visualize/dqn_cluster_k8_seed0/position_coverage/iter-best_position/'
        else:
            visualize_path = f'/Users/puyuan/code/DI-engine/data_lunarlander_visualize/dqn_cluster_k8_seed0/position_coverage/iter-{iter}_position/'
