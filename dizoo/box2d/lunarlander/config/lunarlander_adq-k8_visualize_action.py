...
def train(args):
    ...
    for iter in [0, 10000, 40000, 80000, 190000, 380000, -1]:
        if iter == -1:
    ...
    # warmup end in 10000 iter, i.e. 26436 env step
    # 20000 iter, i.e. 52872 env step
    env_steps = [0, 52872, 100000, 200000, 500000, 1000000, 3000000]
    ...
    print('iter_noop_action_cnt_list',  iter_noop_action_cnt_list)
