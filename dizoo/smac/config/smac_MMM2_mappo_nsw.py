...
main_config = dict(
    ...
    policy=dict(
        ...
        model=dict(
            ...
            agent_num=agent_num,
            # (int) obs_shape: The shape dimensionof observation of each agent.
            # For 3s5z, obs_shape=150; for 2c_vs_64zg, agent_num=404.
            # (int) global_obs_shape: The shape dimension of global observation.
...
def train(args):
    main_config.exp_name='debug_smac_mmm2_mappo_nsw'+'_seed'+f'{args.seed}'
